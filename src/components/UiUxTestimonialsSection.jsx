...
const UiUxTestimonialsSection = ({ testimonials }) => {
      ...
      <div className='container mx-auto px-4 max-w-7xl'>
        <div className='text-center mb-16'>
          ...
          <p className='text-gray-600 text-lg max-w-3xl mx-auto'>
            {t('services.uiux.testimonials.subtitle')}
          </p>
        </div>
              ...
              >
                <div className='w-24 h-24 mb-6'>
                  <img
                    ...
                    alt={t(
                      `services.uiux.testimonials.items.${testimonial.id}.author`
                    )}
                ...
                <p className='text-accent font-semibold mb-2'>
                  {t(
                    `services.uiux.testimonials.items.${testimonial.id}.position`
                  )}
                </p>
                <p className='text-gray-600 text-sm leading-relaxed'>
                  "
                  {t(
                    `services.uiux.testimonials.items.${testimonial.id}.quote`
                  )}
                  "
                </p>
              </div>
...
export default UiUxTestimonialsSection;
